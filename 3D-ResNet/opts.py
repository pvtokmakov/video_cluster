...
def parse_opts():
    ...
    parser.add_argument(
        ...
        default='kinetics',
        type=str,
        help='Used dataset (kinetics | ucf101 | hmdb51)')
    parser.add_argument(
        '--n_classes',
        default=400,
        type=int,
        help=
        'Number of classes (kinetics: 400, ucf101: 101, hmdb51: 51)'
    )
    parser.add_argument(
        '--n_finetune_classes',
        default=400,
    ...
    parser.add_argument(
        ...
        default='',
        type=str,
        help='Folder that stores label encodings for the movies')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=-1,
        type=int,
        help='Number of training examples per category')
