...
def run(config_path, ir_checkpoint_dir=None, pre_checkpoint_dir=None, cluster_checkpoint_dir=None):
...
if __name__ == "__main__":
    ...
    if config_json['cluster_checkpoint_dir'] is not None:
        print("NOTE: loading cluster assignment")
        cluster_checkpoint_dir = os.path.join(config_json['cluster_checkpoint_dir'], 'checkpoints')
    ...
    run(args.config, ir_checkpoint_dir=ir_checkpoint_dir, pre_checkpoint_dir=pre_checkpoint_dir,
        cluster_checkpoint_dir=cluster_checkpoint_dir)
